...
mixin _$ApiResponse<T, U> {
  ...
  TResult when<TResult extends Object?>(
    TResult Function(T? content, int? statusCode,
            Map<String, List<String>> headers, bool isRedirect)
        $default, {
...
class _$ApiResponseData<T, U> implements ApiResponseData<T, U> {
  ...
  @override
  String toString() {
    return 'ApiResponse<$T, $U>(content: $content, statusCode: $statusCode, headers: $headers, isRedirect: $isRedirect)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(content, statusCode, headers, isRedirect);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(content, statusCode, headers, isRedirect);
  }
...
abstract class ApiResponseData<T, U> implements ApiResponse<T, U> {
  const factory ApiResponseData(
      ...
      required final Map<String, List<String>> headers,
      required final bool isRedirect}) = _$ApiResponseData<T, U>;
